    ...
    <div class="2pt-3">
      <ul class="nav nav-pills flex-column mb-auto">
        <li class="nav-item  my-3">
          <a class="nav-link <?php if($page=='Dashboard'){echo 'active';} ?>"aria-current="page" href="Seller_Dashboard.php">
        ...
        <li class="nav-item">
          <a class="nav-link <?php if($page=='Categories'){echo 'active';} ?>" aria-current="page" href="Categories.php">
            <span data-feather="file"></span>
            Categories
          </a>
        </li>
